...
- Live microphone waveform on the overlay, plus a post-paste chip to save Whisper misspellings to the dictionary
- Highlight text and say "make this shorter" / "more professional" to rewrite the selection
